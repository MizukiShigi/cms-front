  ...
  return (
    <div style={containerStyles}>
      <div style={headerStyles}>
        <h1 style={titleStyles}>設定</h1>
        <p style={subtitleStyles}>アプリケーションの設定を管理できます</p>
      </div>
      
      <div style={contentStyles}>
        <div style={comingSoonStyles}>
          <span style={comingSoonIconStyles}><SettingsIcon size={IconSizes.xl} /></span>
          <h3 style={comingSoonTitleStyles}>設定機能</h3>
